...
},{"./artist_model":2,"backbone":5}],2:[function(require,module,exports){
'use strict';
...
var _artist_template = require('./artist_template');

var _artist_template2 = _interopRequireDefault(_artist_template);
...
var artist = new _artist_collection2['default']();
...
function showArtist() {
	...
	artist.each(function (performer) {
		...
		var data = performer.toJSON();

		var $li = (0, _jquery2['default'])((0, _artist_template2['default'])(data));

		$ol.append($li);
	});
	(0, _jquery2['default'])('body').html($ol);
}
...
},{"./artist_collection":1,"./artist_template":3,"jquery":6,"moment":7,"underscore":8}],5:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
